...
void sda_pin_mode(GPIOMode_TypeDef pin_mode)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;		//第1根引脚
...
{ 	 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;		//第1 2根引脚 SCL
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;		//第1 2根引脚  SDA
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;				//设置输出模式
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;				//开漏模式
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;			//设置IO的速度为100MHz，频率越高性能越好，频率越低，功耗越低
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;			//不需要上拉电阻
